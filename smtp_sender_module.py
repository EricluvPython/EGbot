...
def send_email(SMTP_host="smtp.163.com", from_account="eric_g_0408@163.com", from_passwd="RAZLUTAYTGLGACDG", to_account="2025066613@QQ.com", subject="EGBot Auto Reply", content="Test email"):
